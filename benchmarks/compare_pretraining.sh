...
weasel run experiment-sampling . --vars.pretraining_corpus corpus/no_sampling_train.txt --vars.evaluation_corpus corpus/control_variable_dev.txt --vars.name no_sampling
# Upsampling
...
weasel run experiment-sampling . --vars.pretraining_corpus corpus/up_sampling_train.txt --vars.evaluation_corpus corpus/control_variable_dev.txt --vars.name up_sampling
# Averaging
...
weasel run experiment-sampling . --vars.pretraining_corpus corpus/avg_sampling_train.txt --vars.evaluation_corpus corpus/control_variable_dev.txt --vars.name avg_sampling