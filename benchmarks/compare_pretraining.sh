...
weasel run experiment-sampling . --vars.pretraining_corpus corpus/avg_sampling_train.txt --vars.evaluation_corpus corpus/control_variable_dev.txt --vars.name avg_sampling --vars.max_steps 20000