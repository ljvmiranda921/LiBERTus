...
\subsection{Comparing against a word vector baseline}
\label{sec:results_benchmarking}

We compared our system against a baseline model that uses multi-hash embeddings \cite{miranda-etal-2022-multi}.
...
Figure \ref{fig:benchmarking} shows the results.
...
However, we chose to submit the transformer-based pipeline as our final system because their performance still beats the baseline. 
