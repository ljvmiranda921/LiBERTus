...
Given that the token distribution across all languages is not uniform, we experimented with several sampling techniques.
However, we found that leaving the token distribution as-is leads to more stable pretraining and lower validation scores.
