...
The base model underwent training for 100k steps with a learning rate of 2e-4 whereas the large variant trained for 300k steps.
...
Instead, it uses lexical and subword features based on spaCy's multi-hash embeddings \cite{miranda-etal-2022-multi}.
