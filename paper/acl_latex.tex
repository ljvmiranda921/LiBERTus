...
In addition, we also observe that Old Church Slavonic (\textsc{chu}) and Old East Slavic (\textsc{orv}) are also cross-lingually compatible as they came from the same root.
