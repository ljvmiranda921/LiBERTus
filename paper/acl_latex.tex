...
However, we chose to submit the transformer-based models as our final system because their performance still beats the baseline. 

\subsection{Testing cross-lingual capabilities}
