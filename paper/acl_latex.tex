...
Our general approach involves pretraining a transformer-based multilingual model on the shared task dataset \citep{stgall2017,wurzburg2018, celt1997, csnag,mgtsz2018, simon2014,nivre-etal-2020-universal}, and then finetuning the pretrained model using the Universal Dependencies (UD) annotations of each language.
